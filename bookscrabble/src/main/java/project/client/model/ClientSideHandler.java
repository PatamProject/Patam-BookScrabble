...
public class ClientSideHandler implements RequestHandler{
    ...
    public ClientSideHandler(OutputStream out) {
        ...
        commandHandler = new HashMap<>(){{
            ...
            put("!board", (String[] args) -> game.setBoard(args));
    
            //A player placed a word on the board
            put("!Q", (String[] args) -> handleWordPlacement(args));
    
            //A player challenged a word placement and it was accepted
            put("!C", (String[] args) -> handleWordPlacement(args));
        }};

        //ErrorHandler (errors from the host)
        errorHandler = new HashMap<>(){{
            put(Error_Codes.UNKNOWN_CMD, (String[] args) -> System.out.println("Unknown command"));
            put(Error_Codes.INVALID_ARGS, (String[] args) -> System.out.println("Invalid arguments for command"));
            put(Error_Codes.MISSING_ARGS, (String[] args) -> System.out.println("Missing arguments for command"));
            put(Error_Codes.SERVER_ERR, (String[] args) -> System.out.println("Server error"));
            put(Error_Codes.ACCESS_DENIED, (String[] args) -> System.out.println("Access denied, you are not permitted to use this command"));
            put(Error_Codes.SERVER_FULL, (String[] args) -> System.out.println("Server is full, try again later"));
            put(Error_Codes.GAME_STARTED, (String[] args) -> System.out.println("Game has already started, you can't join now"));
            put(Error_Codes.NAME_TAKEN, (String[] args) -> System.out.println("Name is already taken, try another name"));
            put(Error_Codes.NOT_YOUR_TURN, (String[] args) -> System.out.println("It's not your turn, you can't use this command now"));
            put(Error_Codes.NOT_ENOUGH_PLAYERS, (String[] args) -> System.out.println("Can't start game, not enough players"));
