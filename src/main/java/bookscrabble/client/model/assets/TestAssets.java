...
import bookscrabble.client.model.assets.Tile.Bag;
...
public class TestAssets {
	...
	public static void testBoard() {
		...
		if(b.tryPlaceWord(farm)!=9)
			System.out.println("problem in placeWord for 2nd word (-10)");

		Word paste=new Word(get("PASTE"), 9, 5, false);
		if(b.tryPlaceWord(paste)!=25)
			System.out.println("problem in placeWord for 3rd word (-10)");
